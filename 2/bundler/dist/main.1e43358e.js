...
function diffDates(firstDate, secondDate) {
  ...
  if (firstDate > secondDate) secondDate = [firstDate, firstDate = secondDate][0]; // 2
...
function handleCalcDates(event) {
  ...
  if (firstDate && secondDate) {
    var diff = (0, _datecalc.diffDates)(firstDate, secondDate); // 3

    dateCalcResult.innerHTML = (0, _datecalc.diffToHtml)(diff); // 4
  } else dateCalcResult.innerHTML = (0, _utils.formatError)("Для расчета промежутка необходимо заполнить оба поля"); // 5

}
},{"./datecalc.js":"src/datecalc.js","./utils.js":"src/utils.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
